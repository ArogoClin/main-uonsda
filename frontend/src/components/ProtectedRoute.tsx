        ...
        return (
          <div className="min-h-screen bg-gray-100 flex items-center justify-center">
            <div className="bg-white p-8 rounded-lg shadow-lg max-w-md text-center">
              ...
              <h2 className="text-2xl font-bold text-orange-600 mb-2">Access Denied</h2>
              ...
              <a 
                href={redirectPath} 
                className="inline-block px-6 py-2 bg-orange-600 text-white rounded-lg hover:bg-yellow-700 transition"
              >
